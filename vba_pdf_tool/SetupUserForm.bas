Attribute VB_Name = "modPMSetup"
Option Explicit

"Automates creation of the PDF Manager userform with unique control names"
Public Sub PM_CreateManagerForm()
    ...
    With comp.CodeModule
        .InsertLines .CountOfLines + 1, _
            "Private Sub pmBtnBrowse_Click()" & vbCrLf & _
            ...
            "        Me.pmTxtPath.Text = fd.SelectedItems(1)" & vbCrLf & _
            "    End If" & vbCrLf & _
            "End Sub" & vbCrLf & _
            "" & vbCrLf & _
            "Private Sub pmBtnRun_Click()" & vbCrLf & _
            "    Dim action As String" & vbCrLf & _
            "    action = Me.pmCboAction.Value" & vbCrLf & _
            "    Select Case action" & vbCrLf & _
            "        Case \"Export Sheet to PDF\"" & vbCrLf & _
            "            PM_ExportActiveSheet Me.pmTxtPath.Text" & vbCrLf & _
            "        Case \"Merge PDFs\"" & vbCrLf & _
            "            PM_MergeSelectedPDFs Me.pmTxtPath.Text" & vbCrLf & _
            "        Case \"Split PDF\"" & vbCrLf & _
            "            PM_SplitSelectedPDF Me.pmTxtPath.Text" & vbCrLf & _
            "        Case \"Delete Pages\"" & vbCrLf & _
            "            PM_DeletePagesFromSelectedPDF Me.pmTxtPath.Text" & vbCrLf & _
            "    End Select" & vbCrLf & _
            "End Sub" & vbCrLf & _
            "" & vbCrLf & _
            "Private Sub pmBtnClose_Click()" & vbCrLf & _
            "    Unload Me" & vbCrLf & _
            "End Sub"
    End With
