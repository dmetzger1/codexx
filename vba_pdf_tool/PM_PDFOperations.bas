Attribute VB_Name = "PM_PDFOperations"
Option Explicit
...
Public Sub PM_SplitSelectedPDF(ByVal pdfPath As String)
    ...
    outputFolder = GetFolder("Select folder for split pages")
...
Private Function GetFolder(prompt As String) As String
    Dim fd As FileDialog
    Set fd = Application.FileDialog(msoFileDialogFolderPicker)
    fd.Title = prompt
    If fd.Show Then GetFolder = fd.SelectedItems(1)
End Function
